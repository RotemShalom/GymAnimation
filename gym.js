...
lib.ssMetadata = [
		...
		{name:"gym_atlas_2", frames: [[0,1699,595,227],[597,1699,595,227],[1026,390,595,227],[0,1026,1126,671],[1026,619,390,227],[0,0,1024,1024],[1026,0,518,388],[1546,0,96,130],[1418,619,60,130],[1026,848,72,130]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f().s("#000000").ss(8,1,1).p("A24t8IAACgIAAFWIAAABIAALqIAAJEA28mGIAEAAA28mGIAEABIEUAFA5YmIICcACAoRneIAAnKAoqFlIAAGuAoqENIAABYIZdAAIAAC+IC0AAA24FlIOOAAAZPIjIAKAAAMlIjIEOAAIAAFoAGzIjIAKAA");
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).to({_off:true},1).wait(853));
...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#E7A97B").s().p("");
	this.shape_1.setTransform(34.9357,-25.9707);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#EDD2B3").s().p("");
	this.shape_2.setTransform(-1.3878,-0.9297);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("");
	this.shape_3.setTransform(2.4965,0.0667);
...
p.nominalBounds = new cjs.Rectangle(-225,-162.2,450.3,324.6);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(105).to({_off:false},0).to({alpha:1},14).to({alpha:0},14).to({_off:true},1).wait(720));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(779).to({_off:false},0).to({scaleX:1.0067,scaleY:1.0067,x:680.05,y:513.7},11,cjs.Ease.get(1)).to({scaleX:0.7446,scaleY:0.7446},6,cjs.Ease.get(-1)).wait(58));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(768).to({_off:false},0).to({regX:16.3,regY:22.7,scaleX:0.0706,scaleY:0.0706},11,cjs.Ease.get(1)).to({regX:16.1,regY:22.1,scaleX:0.0589,scaleY:0.0589},8,cjs.Ease.get(-1)).wait(67));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(541.3,512.2,0.2967,0.3028,0,0,0,8.2,10.9);

	this.instance_1 = new lib.BG("synched",0);
	this.instance_1.setTransform(648.15,491.7,0.2967,0.3028,0,0,0,8.2,8.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1},{t:this.instance}]},120).wait(734));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.start_btn}]}).to({state:[]},2).to({state:[{t:this.startAgain_btn}]},812).to({state:[{t:this.startAgain_btn}]},40).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.startAgain_btn).wait(814).to({_off:false},0).to({alpha:1},40).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	// clock
	this.instance = new lib.clock_1("single",0);
	this.instance.setTransform(1244.35,-248.9,0.8908,0.8908);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(410).to({startPosition:0},0).to({scaleX:1.7486,scaleY:1.7486,x:366.6,y:-57.75},90,cjs.Ease.quadInOut).wait(6).to({mode:"synched",loop:false},0).wait(114).to({y:14.05,mode:"single",startPosition:64},0).to({scaleX:0.8908,scaleY:0.8908,x:1244.35,y:-248.9,startPosition:0},19,cjs.Ease.quadInOut).wait(1));
	...
	// circle3_leg
	this.instance_1 = new lib.legsanimation();
	this.instance_1.setTransform(963.25,579.4,0.047,0.0467,0,0,0,1.1,0);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(132).to({_off:false},0).to({regX:0,scaleX:1,scaleY:1},8,cjs.Ease.get(1)).wait(36).to({alpha:0},10).wait(454));

	// circle2_leg
	this.instance_2 = new lib.legsanimation();
	this.instance_2.setTransform(808.3,400.3,0.047,0.0467,0,0,0,0,1.1);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(116).to({_off:false},0).to({regY:0,scaleX:1,scaleY:1},8,cjs.Ease.get(1)).wait(52).to({alpha:0},10).wait(454));

	// circle1_leg
	this.instance_3 = new lib.legsanimation();
	this.instance_3.setTransform(700,573.05,0.047,0.0467);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(99).to({_off:false},0).to({scaleX:1,scaleY:1},8,cjs.Ease.get(1)).wait(69).to({alpha:0},10).wait(454));

	// arrows_animation
	this.instance_4 = new lib.directionarrow("synched",0);
	this.instance_4.setTransform(301.65,486.95,0.177,0.177,139.5406,0,0,0.4,-0.5);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(187).to({_off:false},0).to({alpha:1},9).wait(14).to({startPosition:0},0).to({x:379.05,y:422.65},65,cjs.Ease.sineInOut).to({alpha:0},9).wait(20).to({regY:-0.1,rotation:-31.7421,x:435.95,y:381.7,alpha:1},0).to({rotation:-31.7421,x:327.5,y:466.5},83,cjs.Ease.sineInOut).to({alpha:0},12).wait(241));

	// legs_outline
	this.instance_5 = new lib.legscopy("synched",0);
	this.instance_5.setTransform(866.75,519.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(209).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(94).to({startPosition:0},0).wait(202).to({startPosition:0},0).wait(50).to({startPosition:0},0).wait(84));

	// chest
	this.instance_6 = new lib.BODY("synched",0);
	this.instance_6.setTransform(581.35,595.15,1,1,0,0,0,72,75.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(209).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).to({regY:75.5,rotation:14.9983,x:593.9,y:596.45},64,cjs.Ease.sineInOut).wait(29).to({startPosition:0},0).to({regY:75.6,rotation:0,x:581.35,y:595.15},83,cjs.Ease.sineInOut).wait(119).to({startPosition:0},0).to({regY:75.5,rotation:14.9983,x:593.9,y:596.45},8,cjs.Ease.sineInOut).wait(2).to({startPosition:0},0).to({regY:75.6,rotation:0,x:581.35,y:595.15},6,cjs.Ease.sineInOut).wait(2).to({startPosition:0},0).to({regY:75.5,rotation:14.9983,x:593.9,y:596.45},6,cjs.Ease.sineInOut).wait(2).to({startPosition:0},0).to({regY:75.6,rotation:0,x:581.35,y:595.15},6,cjs.Ease.sineInOut).wait(2).to({startPosition:0},0).to({regY:75.5,rotation:14.9983,x:593.9,y:596.45},6,cjs.Ease.sineInOut).wait(2).to({startPosition:0},0).to({regY:75.6,rotation:0,x:581.35,y:595.15},6,cjs.Ease.sineInOut).wait(2).to({startPosition:0},0).to({regY:75.5,rotation:14.9983,x:593.9,y:596.45},8,cjs.Ease.sineInOut).wait(2).to({startPosition:0},0).to({regY:75.6,rotation:0,x:581.35,y:595.15},6,cjs.Ease.sineInOut).wait(68));

	// head
	this.instance_7 = new lib.ראש("synched",0);
	this.instance_7.setTransform(286.15,587.95,1,1,0,0,0,48.6,28.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(209).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).to({regX:48.8,rotation:24.6989,x:320.1,y:515.2},64,cjs.Ease.sineInOut).wait(29).to({startPosition:0},0).to({regX:48.6,rotation:0,x:286.15,y:587.95},83,cjs.Ease.sineInOut).wait(119).to({startPosition:0},0).to({regX:48.8,rotation:24.6989,x:320.1,y:515.2},8,cjs.Ease.sineInOut).wait(2).to({startPosition:0},0).to({regX:48.6,rotation:0,x:286.15,y:587.95},6,cjs.Ease.sineInOut).wait(2).to({startPosition:0},0).to({regX:48.8,rotation:24.6989,x:320.1,y:515.2},6,cjs.Ease.sineInOut).wait(2).to({startPosition:0},0).to({regX:48.6,rotation:0,x:286.15,y:587.95},6,cjs.Ease.sineInOut).wait(2).to({startPosition:0},0).to({regX:48.8,rotation:24.6989,x:320.1,y:515.2},6,cjs.Ease.sineInOut).wait(2).to({startPosition:0},0).to({regX:48.6,rotation:0,x:286.15,y:587.95},6,cjs.Ease.sineInOut).wait(2).to({startPosition:0},0).to({regX:48.8,rotation:24.6989,x:320.1,y:515.2},8,cjs.Ease.sineInOut).wait(2).to({startPosition:0},0).to({regX:48.6,rotation:0,x:286.15,y:587.95},6,cjs.Ease.sineInOut).wait(68));

	// legs
	this.instance_8 = new lib.legs("synched",0);
	this.instance_8.setTransform(866.75,519.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(209).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(94).to({startPosition:0},0).wait(336));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(141.9,-389.2,1217,1076.9);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(120).to({_off:false},0).wait(734));
...
if (reversed == null) { reversed = false; }
	...
	this.actionFrames = [0,2,133,319,432,542,691,770,814,853,854];
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(2).call(this.frame_2).wait(131).call(this.frame_133).wait(186).call(this.frame_319).wait(113).call(this.frame_432).wait(110).call(this.frame_542).wait(149).call(this.frame_691).wait(79).call(this.frame_770).wait(44).call(this.frame_814).wait(39).call(this.frame_853).wait(1).call(this.frame_854).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.button).wait(2).to({regX:653.2,regY:420.1,scaleX:1.0119,scaleY:1.0119,x:653.3,y:418.55},0).wait(812).to({regX:704.9,regY:543.1,scaleX:6.4733,scaleY:6.4733,x:653.5,y:418.2},0).to({regX:653.4,regY:418.5,scaleX:1,scaleY:1,x:653.4,y:418.5},40).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btn_BG).wait(1).to({regY:357.6,scaleX:1.0059,scaleY:1.0059,y:356.45},0).wait(852).to({regX:702.7,regY:533.5,scaleX:6.4733,scaleY:6.4733,x:639.25,y:356.05},0).to({_off:true},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.white_board).wait(105).to({regX:401.4,regY:339.1,scaleX:2.6315,scaleY:2.6315,x:-0.1,y:0.15},0).to({regX:455.1,regY:384.3,scaleX:3.3632,scaleY:3.3632,x:0.2,y:0.05},14).wait(734).to({regX:604,regY:478.5,scaleX:6.4733,scaleY:6.4733,x:0.35},0).to({_off:true},1).wait(1));
	...
	this.V_Sign.layerIndex = 3
	this.V_Sign.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.V_Sign).wait(779).to({regX:604,regY:478.5,scaleX:6.4733,scaleY:6.4733,x:0.35,y:0.05},0).wait(17).to({_off:true},58).wait(1));
	...
	this.muscle.layerIndex = 4
	this.muscle.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.muscle).wait(768).to({regX:604,regY:478.5,scaleX:6.4733,scaleY:6.4733,x:0.35,y:0.05},0).wait(19).to({_off:true},67).wait(1));
	...
	this.men.layerIndex = 5
	this.men.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.men).wait(120).to({regX:455.1,regY:384.3,scaleX:3.3632,scaleY:3.3632,x:0.2,y:0.05},0).to({_off:true},734).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.BG).wait(120).to({regX:455.1,regY:384.3,scaleX:3.3632,scaleY:3.3632,x:0.2,y:0.05},0).to({_off:true},734).wait(1));
	...
	this.leftDoorAnimation.layerIndex = 7
	this.leftDoorAnimation.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.leftDoorAnimation).wait(84).to({regX:321.2,regY:271.2,scaleX:1.9841,scaleY:1.9841,x:0.1,y:-0.05},0).to({regX:412.9,regY:348.8,scaleX:2.7602,scaleY:2.7602,x:-0.1,y:0.15},24).to({_off:true},12).wait(735));
	...
	this.innerDoors.layerIndex = 8
	this.innerDoors.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.innerDoors).wait(84).to({regX:641.4,regY:538.9,scaleX:1.9841,scaleY:1.9841,x:635.4,y:531.1},0).to({regX:643.1,regY:541.1,scaleX:2.7602,scaleY:2.7602,x:635.3,y:530.95},24).to({_off:true},12).wait(735));
	...
	this.outlineDoors.layerIndex = 9
	this.outlineDoors.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.outlineDoors).to({_off:true},120).wait(735));
	...
	this.gym_doors.layerIndex = 10
	this.gym_doors.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.gym_doors).to({_off:true},120).wait(735));
	...
	this.front_gym.layerIndex = 11
	this.front_gym.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.front_gym).to({_off:true},120).wait(735));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(639,352.8,642,368.49999999999994);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"images/gym_atlas_2.png", id:"gym_atlas_2"},
		{src:"sounds/clock.mp3", id:"clock"},
		{src:"sounds/part1.mp3", id:"part1"},
		{src:"sounds/part2.mp3", id:"part2"},
		{src:"sounds/part3.mp3", id:"part3"},
		{src:"sounds/part4.mp3", id:"part4"},
		{src:"sounds/part5.mp3", id:"part5"}
	],
	preloads: []
};
